  ...
  return (
    <section className="w-full min-h-screen  flex  items-center justify-evenly ">
       ...
       <div className='max-w-[315px] md:max-w-[454px]    w-full h-full min-h-[700px] max-h-[750px]  flex flex-col items-center gap-8 py-10 px-6 md:px-2'>
        ...
        <div className='relative bg-[#49bbbd9a] w-full max-w-[329px] min-h-14 h-14 rounded-full p-2 flex justify-between items-center '> 
            ...
            <span className={isRegistered ? 'block transtion bg-lprimary opacity-100 h-10 min-w-28  w-[50%] absolute -z-10  rounded-full right-2 ': " block transtion bg-lprimary  w-[50%] h-10  min-w-28 absolute -z-10 border rounded-full"}></span>
        </div>
